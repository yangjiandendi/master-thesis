...
public class kriging_layer1 : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        InitGrid();
        BuildMesh();
        var ob2 = GameObject.Find("kriging_model_layer1").GetComponent<Collider>();
        ob2.enabled = false;
    ...
    private void InitGrid()
    {
        ...
        //var p1 = intp_[(int)layer1_y1 + 1][(int)layer1_x1 + 1][(int)layer1_z1 + 1] * ((layer1_x1 - (int)layer1_x1)+(layer1_y1 - (int)layer1_y1)+ (layer1_z1 - (int)layer1_z1))/3;
        //var p2 = intp_[(int)layer1_y1][(int)layer1_x1][(int)layer1_z1] * ((1 - layer1_x1 + (int)layer1_x1)+ (1 - layer1_y1 + (int)layer1_y1)+ (1 - layer1_z1 + (int)layer1_z1))/3;

        var p1_x = intp_[(int)layer1_y1][(int)layer1_x1 + 1][(int)layer1_z1] * (layer1_x1 - (int)layer1_x1);
        var p1_y = intp_[(int)layer1_y1 + 1][(int)layer1_x1][(int)layer1_z1] * (layer1_y1 - (int)layer1_y1);
        var p1_z = intp_[(int)layer1_y1][(int)layer1_x1][(int)layer1_z1 + 1] * (layer1_z1 - (int)layer1_z1);
        var p1 = (p1_x + p1_y + p1_z) / 3;

        var p2_x = intp_[(int)layer1_y1][(int)layer1_x1][(int)layer1_z1] * (1 - layer1_x1 + (int)layer1_x1);
        var p2_y = intp_[(int)layer1_y1][(int)layer1_x1][(int)layer1_z1] * (1 - layer1_y1 + (int)layer1_y1);
        var p2_z = intp_[(int)layer1_y1][(int)layer1_x1][(int)layer1_z1] * (1 - layer1_z1 + (int)layer1_z1);
